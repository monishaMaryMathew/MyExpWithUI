...
import com.example.monisha.myexpwithui.util.WaveHelper;
import com.example.monisha.myexpwithui.view.SecretTextView;
import com.example.monisha.myexpwithui.view.WaveView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        secretTextView = (SecretTextView) findViewById(R.id.secret_textview);
        secretTextView.hide();
